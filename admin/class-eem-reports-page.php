...
class EEM_Reports_Page {
	...
	private function report_catalog(): array {
		return array(
			...
			array( 'slug' => 'add_ons', 'tone' => 'shavings', 'title' => __( 'Add-Ons', 'equine-event-manager' ), 'desc' => __( 'Add-on quantities. All reservations: totals per add-on. A single reservation: a per-day worksheet showing how many of each add-on are needed each day.', 'equine-event-manager' ) ),
