...
class EEM_Admin {
	...
	public function register_menu() {
		...
		// (CLEANUP #20 DONE 2026-07-01: the legacy render_order_details_page +
		// its exclusive render_order_totals_table helper — ~485 dead LOC — were
		// removed now that EEM_Order_Detail_Page fully owns this surface.)
