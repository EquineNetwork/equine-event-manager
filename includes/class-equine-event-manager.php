...
require_once EQUINE_EVENT_MANAGER_PATH . 'includes/class-eem-charge-recovery.php';
...
require_once EQUINE_EVENT_MANAGER_PATH . 'includes/class-eem-native-event-repo.php';
require_once EQUINE_EVENT_MANAGER_PATH . 'includes/class-eem-events-repo.php';
...
class EEM_Plugin {
	...
	public function run() {
		...
		add_action( 'admin_post_eem_reservation_set_draft',       array( 'EEM_Reservations_List_Page', 'handle_set_draft' ) );
		add_action( 'admin_post_eem_reservation_set_published',   array( 'EEM_Reservations_List_Page', 'handle_set_published' ) );
