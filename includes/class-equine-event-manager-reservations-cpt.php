...
class EEM_Reservations_CPT {
	...
	public function sanitize_meta_submission( $source, $existing = array() ) {
		...
		$data = array(
			...
			'stalls_schedule_message'         => isset( $source['stalls_schedule_message'] ) ? sanitize_textarea_field( $source['stalls_schedule_message'] ) : '',
			...
			'rv_schedule_message'             => isset( $source['rv_schedule_message'] ) ? sanitize_textarea_field( $source['rv_schedule_message'] ) : '',
