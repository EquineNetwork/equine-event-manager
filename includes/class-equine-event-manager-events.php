...
class EEM_Events {
	...
	public function register_content_types() {
		...
		register_post_type(
			...
			array(
				'labels'       => array(
					'name'               => __( 'Venues', 'equine-event-manager' ),
					'singular_name'      => __( 'Venue', 'equine-event-manager' ),
					'add_new'            => __( 'Add Venue', 'equine-event-manager' ),
					'add_new_item'       => __( 'Add Venue', 'equine-event-manager' ),
					...
					'search_items'       => __( 'Search Venues', 'equine-event-manager' ),
					'not_found'          => __( 'No venues found.', 'equine-event-manager' ),
					'not_found_in_trash' => __( 'No venues found in Trash.', 'equine-event-manager' ),
					'menu_name'          => __( 'Venues', 'equine-event-manager' ),
				),
				'public'       => false,
				'show_ui'      => true,
				'show_in_menu' => false,
		...
		register_taxonomy(
			...
			array(
				'labels'            => array(
					'name'          => __( 'Venue Categories', 'equine-event-manager' ),
					'singular_name' => __( 'Venue Category', 'equine-event-manager' ),
					'search_items'  => __( 'Search Venue Categories', 'equine-event-manager' ),
					'all_items'     => __( 'All Venue Categories', 'equine-event-manager' ),
					'edit_item'     => __( 'Edit Venue Category', 'equine-event-manager' ),
					'update_item'   => __( 'Update Venue Category', 'equine-event-manager' ),
					'add_new_item'  => __( 'Add Venue Category', 'equine-event-manager' ),
					'new_item_name' => __( 'New Venue Category Name', 'equine-event-manager' ),
