...
$check( 'eem_sheets_event query var registered', in_array( 'eem_sheets_event', $events->filter_query_vars( array() ), true ) );
$check( 'public-page handler exists', method_exists( 'EEM_Events', 'maybe_render_sheets_results_page' ) );
...
$check( 'public page renders the hero', false !== strpos( $html, 'eem-sr-public-hero' ) );
