 ...
 *   _en_event_pre_entries          array of {title, inventory, price}
 *
 * @package   EEM_Plugin
...
$pre_entries      = ( is_array( $pre_entries_meta ) && ! empty( $pre_entries_meta ) )
	? $pre_entries_meta
	: array(
		array( 'title' => 'Friday Reining Class',   'inventory' => '30', 'price' => '75.00' ),
		array( 'title' => 'Saturday Cutting Class',  'inventory' => '25', 'price' => '95.00' ),
	);
?>
