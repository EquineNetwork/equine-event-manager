...
eem_render_editor_field_row( array(
	...
	'control_html' => sprintf(
		'<div class="eem-rate-inline-pair"><div class="eem-eb-inline"><span class="eem-eb-inline__label">%5$s</span><div class="eem-price-wrap"><span class="eem-price-symbol">$</span><input class="eem-price-input" type="number" step="0.01" min="0" name="en_reservation[stall_nightly_rate]" value="%1$s" /></div></div><div class="eem-eb-inline%3$s" id="eem-stall-eb-nightly-row"><span class="eem-eb-inline__label">%2$s</span><div class="eem-price-wrap"><span class="eem-price-symbol">$</span><input class="eem-price-input" type="number" step="0.01" min="0" name="en_reservation[stall_early_bird_nightly_rate]" value="%4$s" /></div></div></div>',
...
?>
<div id="eem-stall-packages-list-wrap" class="<?php echo ( $eb_on && $schedule_on ) ? 'eem-pkg-eb-on' : ''; ?>"<?php echo $show_packages ? '' : ' style="display:none"'; ?>>
	<div class="eem-pkg-header">
		<span class="eem-pkg-h eem-pkg-h--name"><?php esc_html_e( 'Title', 'equine-event-manager' ); ?></span>
		<span class="eem-pkg-h eem-pkg-h--date"><?php esc_html_e( 'Start Date', 'equine-event-manager' ); ?></span>
		<span class="eem-pkg-h eem-pkg-h--sep"></span>
		<span class="eem-pkg-h eem-pkg-h--date"><?php esc_html_e( 'End Date', 'equine-event-manager' ); ?></span>
		<span class="eem-pkg-h eem-pkg-h--price"><?php esc_html_e( 'Standard', 'equine-event-manager' ); ?></span>
		<span class="eem-pkg-h eem-pkg-h--price eem-pkg-eb-wrap"><?php esc_html_e( 'Early Bird', 'equine-event-manager' ); ?></span>
		<span class="eem-pkg-h eem-pkg-h--del"></span>
	</div>
	...
	<div class="eem-package-inline-form" id="eem-stall-package-form" style="display:none">
		<div class="eem-pkg-row">
			...
			<div class="eem-pkg-price-wrap eem-pkg-eb-wrap" title="<?php esc_attr_e( 'Early Bird Price', 'equine-event-manager' ); ?>"><span class="eem-pkg-price-sym">$</span><input type="number" step="0.01" min="0" class="eem-pkg-price-input" id="eem-stall-pkg-eb-price"></div>
...
echo '<p class="eem-field-hint eem-sched-group__hint">' . esc_html__( 'Automatically add shavings to each stall reservation.', 'equine-event-manager' ) . '</p>';
echo '<div class="eem-sched-fields eem-sched-fields--inline' . ( $shavings_on ? '' : ' eem-row--hidden' ) . '" id="row-stall-shavings-details">';
printf(
	'<div class="eem-sched-field"><span class="eem-sched-field__label">%s</span><div class="eem-price-wrap" style="max-width:110px"><span class="eem-price-symbol">#</span><input class="eem-price-input" type="number" min="0" step="1" name="en_reservation[required_shavings_per_stall]" value="%s" /></div></div>',
	esc_html__( 'Bags Per Stall', 'equine-event-manager' ),
	esc_attr( (string) ( $data['required_shavings_per_stall'] ?? '0' ) )
);
printf(
	'<div class="eem-sched-field"><span class="eem-sched-field__label">%s</span><div class="eem-price-wrap"><span class="eem-price-symbol">$</span><input class="eem-price-input" type="number" step="0.01" min="0" name="en_reservation[required_shavings_price]" value="%s" /></div></div>',
