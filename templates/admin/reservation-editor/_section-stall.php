			...
			<tbody id="eem-stall-packages-tbody">
				...
				<tr data-package-id="<?php echo (int) $pkg['id']; ?>">
					...
					<td class="eem-packages-col-actions">
						<button type="button" class="eem-btn-icon" data-eem-action="stall-package-edit" data-package-id="<?php echo (int) $pkg['id']; ?>" aria-label="<?php esc_attr_e( 'Edit package', 'equine-event-manager' ); ?>" title="<?php esc_attr_e( 'Edit', 'equine-event-manager' ); ?>"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg></button>
						<button type="button" class="eem-btn-icon eem-btn-icon--danger" data-eem-action="stall-package-delete" data-package-id="<?php echo (int) $pkg['id']; ?>" aria-label="<?php esc_attr_e( 'Delete package', 'equine-event-manager' ); ?>" title="<?php esc_attr_e( 'Delete', 'equine-event-manager' ); ?>"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/></svg></button>
					</td>
				</tr>
				<?php endforeach; ?>
			</tbody>
